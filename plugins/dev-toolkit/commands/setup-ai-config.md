...
> 生成物がこの3境界を等価に含むことは、`plugins/dev-toolkit/tests/setup-ai-config/` の期待生成物 fixture と `verify.sh` で検証する。
...
- 生成物が3境界を等価に含むことは `plugins/dev-toolkit/tests/setup-ai-config/verify.sh` で検証できる
