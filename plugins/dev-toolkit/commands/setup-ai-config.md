---
description: プロジェクトの docs/ を基に AI 開発ツール向け設定ファイル（CLAUDE.md / .cursorrules / copilot-instructions.md）を生成し、Multi-CLI エージェントをセットアップする
---
...
[docs/05-operations/deployment/self-review.md から要約（存在する場合。なければ省略可）]
