...
観点「受け入れ条件の明示」は `/create-issue` 側に対応が無い本スキル固有の追加です。表で「非継承」としている項目は、いずれも**書く値・書く対象の出所を着手前に確定させる**ことを求めるもので、その確定の責務が起票ゲート側にあるためです。本スキルは既に立った Issue の記述の曖昧さを扱います。
